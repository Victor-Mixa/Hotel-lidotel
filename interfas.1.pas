	      ...
	      writeln('--------------------------------');
            ...
            if opcion=1 then
              begin
                ...
                writeln('');
                writeln('Incluye: Desayuno Buffet en el restaurant Le Nouveau, acceso inalambrico a internet (WIFI)  Business Center.');
                writeln('Uso de nuestra exclusiva piscina, acceso a nuestro gimnasio, sillas y toldos en la playa, kit de vanidades y niños de 0 a 2 anos sin recargas.');
              end;
            if (opcion)=2 then
              begin
                writeln('Amplia y confortable habitación decorada con un estilo vanguardista, cama Lidotel Royal King con sabanas de algodon egipcio.');
                writeln('Soporte para iPod con reloj despertador, TV 32" HD Plasma con cable, bano con ducha, cafetera electrica, nevera ejecutiva caja electronica de seguridad y secador de cabello.');
                writeln(''); 
                writeln('Incluye: Desayuno Buffet en el restaurant Le Nouveau acceso inalambrico a internet (WIFI), acceso a las instalaciones de Business Center.');
                writeln('Uso de nuestra exclusiva piscina acceso a nuestro moderno gimnasio y kit de vanidades, nino de 0 a 2 anos sin recargas.');
            ...
            if (opcion)=3 then
              begin
                writeln('Amplia y confortable habitacion decorada con un estilo vanguardista, dos camas Lidotel Royal King con sabanas de algodón egipcio.');		
		writeln('Soporte para iPod con reloj despertador, TV 32 HD plasma con cable, bano con ducha, cafetera Electrica, nevera ejecutiva, caja electronica de seguridad y secador de cabello.');
                writeln('');
		writeln('Incluye: Desayuno Buffet en el restaurant Le Nouveau, acceso inalambrico a internet (WIFI), acceso a las instalaciones de Business Center.');
                writeln('Uso de nuestra exclusiva piscina, acceso a nuestro moderno gimnasio y kit de vanidades. Nino de 0 a');
                writeln('Kit de vanidades, nino de 0 a 2 anos sin recargos.');
              end;
            if (opcion)=4 then
              begin
                writeln('Calida y confortable habitacion decorada con un estilo vanguardista, 100% libre de humo, cama Lidotel Royal King, con reloj despertador.');
                writeln('TV 32" HD Plasma con cable, 2 banos con ducha, cafetera electrica, nevera ejecutiva, caja electronica de seguridad y secador de cabello.');
		writeln('Armario adicional amplio y area separada con 2 sofa-camas individuales.');
                writeln ('');
                writeln('Incluye: Desayuno Buffet en el Restaurant Le Nouveau, acceso inalambrico a internet (WIFI), Business Center');
                writeln('Uso de nuestra exclusiva piscina; acceso a nuestro gimnasio, sillas y toldos en la playa, kit de vanidades y ninos de 0 a 2 anos sin recargos.');
              end;
	  ...
	  repeat
	      ...
	      writeln('--------------------------------');
            ...
            if opcion=1 then
              begin
                writeln('Calida y confortable habitacion decorada con un estilo vanguardista, 100% libre de humo, cama Lidotel Royal King con reloj despertador.');
                writeln('TV 32" HD plasma con cable, bano con ducha, cafetera eléctrica nevera ejecutiva, caja electronica de seguridad y secador de cabello');
                writeln('Armario adicional amplio, una habitacion separada con 2 camas full baño con ducha.');
                writeln('');
                writeln('Incluye: Desayuno Buffet en el Restaurant Le Nouveau, acceso inalambrico a internet (WIFI)  Business Center.');
                writeln('Uso de nuestra exclusiva piscina; acceso a nuestro gimnasio, sillas y Toldos en la playa, kit de vanidades y ninos de 0 a 2 anos sin recargas.'); 
              end; 
            if (opcion)=2 then
              begin
